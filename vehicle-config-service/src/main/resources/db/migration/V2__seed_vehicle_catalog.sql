-- Deterministic seed data for the vehicle catalog.
-- Fixed UUIDs so tests and documentation can reference stable identifiers.

INSERT INTO vehicle_model (id, brand, name, model_year, base_price_cents, description) VALUES
